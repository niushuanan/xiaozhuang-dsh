...
/** These bundled candidates always locate their Markdown in the package assets. */
...
export function createGetNewsTool(toolOptions: { cryptoPanicKey?: string | undefined } = {}) {
  const description =
