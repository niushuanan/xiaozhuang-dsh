...
export const zh: Record<MarketLocaleKey, string> = {
      'workspace.title': 'Trading 交易研究',
      'workspace.close': '关闭交易研究',
      'workspace.sections': '交易研究功能',
      'workspace.market': '行情与研究',
      'workspace.backToConversation': '返回对话',
      'workspace.backToQuote': '返回行情',
      'tab.watch': '自选',
      'tab.crypto': '加密货币',
      'tab.us': '美股',
      'tab.cn': 'A股',
...
export const en: Record<MarketLocaleKey, string> = {
      'workspace.title': 'Trading',
      'workspace.close': 'Close Trading',
      'workspace.sections': 'Trading sections',
      'workspace.market': 'Markets & research',
      'workspace.backToConversation': 'Back to conversation',
      'workspace.backToQuote': 'Back to quotes',
      'tab.watch': 'Watchlist',
      'tab.crypto': 'Crypto',
      'tab.us': 'US Stocks',
      'tab.cn': 'China A',
