...
function readCall(block: ToolCallOwnerProps['block']): { argsRaw: string; resultText: string | null; isError: boolean } {
  ...
  return { argsRaw: 'argsRaw' in block ? block.argsRaw : '', resultText: null, isError: false }
}
...
export function OrderCard(props: CardProps) {
  ...
  return (
    <div className={css.card} data-dshtrading-surface="" data-dshtrading-toolview="place-order" data-state={parsed.state}>
...
export function WatchlistChipCard(props: CardProps) {
  ...
  return (
    <div className={css.card} data-dshtrading-surface="" data-dshtrading-toolview="watchlist">
      <div className={css.head}>
