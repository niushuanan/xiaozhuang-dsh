/**
 * 定时任务面板（3.0）：对话列容器的切换页签——竖条时钟按钮激活时原位
 * 替换对话列内容（同容器二选一，非并排非悬浮），再点收起还原对话。
 *
...
export function ScheduledTasksPanel({ t, openSession, close }: ScheduledTasksPanelProps) {
  ...
  return (
    <div className={css.tasksPanel} data-dshtrading-tasks-panel="" role="region" aria-label={t('tasks.open')}>
