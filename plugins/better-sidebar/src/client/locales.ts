...
export const zh = {
  ...
  agentTerminalSignal: '信号',
  agentTerminalReadonly: '模型独占发送，此视图为只读',
  editor: '编辑器',
  ...
  browserSearchPlaceholder: '输入搜索内容',
  browserModeUrl: '网址',
  browserModeSearch: '直接搜索',
  browserModeAria: '输入模式：{mode}',
  browserGo: '前往',
  browserBack: '后退',
  browserForward: '前进',
  browserStart: '输入网址或搜索内容开始浏览（沙箱模式）',
  ...
  settingsBrowserDefaultModeTitle: '默认输入模式',
  settingsBrowserDefaultModeDesc: '新建浏览器标签时，默认将输入内容解释为网址或直接搜索',
  ...
  browserOpenExternal: '使用系统浏览器打开',
  browserEmbedBlocked: '{host} 拒绝了嵌入请求',
  browserEmbedBlockedDesc: '该站点的安全策略禁止被嵌入，关闭沙箱也无法解决。请使用系统浏览器完整打开',
  subagent: '任务管理',
  openSubagent: '任务管理',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  git: 'Source Control',
  terminal: 'Terminal',
  agentTerminal: 'Model terminal',
  agentTerminalRunning: 'running',
  agentTerminalExited: 'exited',
  agentTerminalSignal: 'signal',
  agentTerminalReadonly: 'read-only — the model owns input',
  editor: 'Editor',
  ...
  browserSearchPlaceholder: 'Enter a search query',
  browserModeUrl: 'URL',
  browserModeSearch: 'Search',
  browserModeAria: 'Input mode: {mode}',
  browserGo: 'Go',
  browserBack: 'Back',
  browserForward: 'Forward',
  browserStart: 'Enter a URL or search query to start browsing (sandbox mode)',
  ...
  settingsBrowserDefaultModeTitle: 'Default input mode',
  settingsBrowserDefaultModeDesc: 'Choose whether a new browser tab treats input as a URL or sends it directly to search',
  ...
  browserEmbedBlockedDesc: 'The site security policy forbids embedding, and disabling the sandbox cannot bypass it. Open the complete page in your system browser instead.',
  subagent: 'Tasks',
  openSubagent: 'Tasks',
...
export function t(key: CopyKey, params?: Record<string, string | number>): string {
  ...
  if (text === undefined) {
    // Key missing from the zh source of truth (should not happen — en is
    // checked against it). Return the key itself so the UI shows something
