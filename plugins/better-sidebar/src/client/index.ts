...
import { LOCALE_NS, attachLocale, t, zh, en, type CopyKey } from './locales.ts'
import css from './sidebar.module.css'
import './layout.css'

/** The sidebar's dictionary namespace, merged into the fork locale registry's
 *  typed namespace table so `ctx.locale.register(NS, { zh, en })` type-checks. */
declare module '@deepseek-ai/dsh-client-ui-slots' {
  interface LocaleNamespaceMap {
    'betterSidebar': CopyKey
  }
}
