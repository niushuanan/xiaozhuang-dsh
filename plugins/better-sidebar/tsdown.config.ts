  ...
  return {
    ...
    resolveId(source: string, importer: string | undefined) {
      ...
      if (source.startsWith('.')) {
        // Source entries normally resolve stylesheets directly. Keep the
        // emitted-path remap for compatibility with direct package builds that
        // elect to feed this config generated JavaScript.
