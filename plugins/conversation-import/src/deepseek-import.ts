...
function importedAssistantStream(
  content: readonly ({ readonly type: 'reasoning' | 'text'; readonly text: string })[],
  time: number,
) {
...
type ImportPersistence = Pick<SessionPersistence, 'list' | 'create'>
type PreviewPersistence = Pick<SessionPersistence, 'list'>
