...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-multi-window': { kind: 'none', reason: 'Browser-side window coordination and navigation UI; registers nothing model-facing.' },
  ...
  'packages/client/ui-product-companion': { kind: 'indirect', reason: 'Owns the companion AGENTS.md editor; the Host prompt pipeline owns injection of the saved file.' },
  ...
  'packages/client/ui-settings-general': { kind: 'indirect', reason: 'Owns the user-editable product System Prompt; dsh-agent-instructions owns model injection of the saved prompt.' },
