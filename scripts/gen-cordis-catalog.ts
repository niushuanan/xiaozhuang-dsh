...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  composerCommandCatalog: 'client-side observable official-command catalog — packages/client/ui-commands/README.md owns the API',
  ...
  multiPane: 'client-side browser split-pane service — packages/client/ui-multi-window/README.md owns the API',
