...
The browser roster mounts [`ui-chat`](../../client/ui-chat/README.md) after the sidebar declaration and supplies the internal `chat` agent preset. This makes Start chat a native optional plugin contribution while preserving Start work and the shared Session runtime.
