...
export const en = {
  ...
  modelCapabilityHint: 'Text-only models use image_vision for images; native-vision models receive images directly. New models default to text-only.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  modelTextOnly: '纯文本',
  modelVision: '原生视觉',
  modelCapabilityHint: '纯文本模型遇到图片时调用 image_vision；原生视觉模型直接接收图片。新增模型默认归为纯文本。',
  contextWindow: '上下文窗口',
