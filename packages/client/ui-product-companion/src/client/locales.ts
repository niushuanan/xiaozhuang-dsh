...
export const zh = {
  ...
  interact: '澜汐；快捷动作可在设置中修改',
  closeAction: '关闭澜汐',
  newSessionAction: '新建对话',
  focusComposerAction: '聚焦输入框',
  nav: '澜汐',
  title: '澜汐',
  intro: '常驻输入框右上方，输入框换位时通过固定尺度的传送门抵达。',
  appearance: '外观',
  'skin.blue': '深海蓝',
...
export const en = {
  ...
  interact: 'Lanxi; customize shortcuts in Settings',
  closeAction: 'Close Lanxi',
  newSessionAction: 'New conversation',
  focusComposerAction: 'Focus composer',
  nav: 'Lanxi',
  title: 'Lanxi',
  intro: 'Lives above the composer’s right edge and uses a fixed-scale portal when it moves.',
  ...
  'action.close': 'Close Lanxi',
  interaction: 'Behavior',
  behavior: 'Visibility and feedback',
  visibleLabel: 'Show Lanxi',
  ...
  resetHint: 'Restore the position where Lanxi first appears.',
