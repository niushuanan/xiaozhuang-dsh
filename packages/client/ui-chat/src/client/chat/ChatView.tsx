...
export function ChatView({
  ...
  // History pages are bounded by message count, so a tool-heavy tail may
  // expose only a handful of turns. Walk to the history head one page at a
  // time so the navigator always represents the complete conversation. The
