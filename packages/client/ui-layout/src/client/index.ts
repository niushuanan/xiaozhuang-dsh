...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  interface SlotMap {
    ...
    /** Browser title projection; the layout supplies the selected Session title. */
    'shell.documentTitle': { kind: 'single'; scope: 'root'; owner: ShellDocumentTitleOwnerProps }
  }
}
...
/** Selected Session metadata supplied to the browser-title occupant. */
export interface ShellDocumentTitleOwnerProps {
  /** Durable selected Session title; absent on the empty product page. */
  title?: string
}
  ...
  ctx.effect(() => {
    ...
    const disposeRegistration = ctx.slots.register({
      ...
      children: {
        ...
        'shell.overlay': { kind: 'list', scope: 'root' },
        'shell.documentTitle': { kind: 'single', scope: 'root' },
      },
