 ...
 * thinking-mode passback. Core image blocks become attachment notes that a host-side vision tool can
 * resolve; unknown declaration-merged block types retain the adapter's documented extension fallback.
