...
| `ctx.computerUse` | `core` | [`computer-use`](../packages/computer-use/computer-use) | - | - | - | Owns slash-triggered Qwen desktop tools, isolated Playwright contexts, the authenticated Chrome bridge, and loopback Settings status. |
