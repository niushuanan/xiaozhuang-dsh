...
Source: [`packages/core/system-prompt/src/index.ts:204`](../packages/core/system-prompt/src/index.ts)
...
- `@deepseek-ai/dsh-client-ui-product-companion` — requires `webServer` ([`packages/client/ui-product-companion/src/index.ts`](../packages/client/ui-product-companion/src/index.ts))
