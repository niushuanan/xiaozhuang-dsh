...
| **Adaptive Update** | Review an official DSH change in disposable worktrees, adapt native plugins in an isolated candidate, validate and shadow-boot it, then switch only while conversations are idle; failed launches restore both code and data automatically. |
